...
class ActionListener implements IMqttActionListener {
    ...
    final String TAG = "MQTT-Listener";
    ...
    public void onSuccess(IMqttToken asyncActionToken) {
        ...
        Toast.makeText(context,"Connect to server ......."+ asyncActionToken.getTopics() +" successful",Toast.LENGTH_LONG).show();
...
//        c.addAction("Client Connected");
        ...
        try {
            MainActivity.mqtt_client.client.subscribe(MainActivity.topic, 0, null, new ActionListener(context, Action.SUBSCRIBE, clientHandle, MainActivity.topic ));
