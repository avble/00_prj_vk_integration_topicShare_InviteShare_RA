                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    ...
                    try {
                        ...
                        if (device.type.contentEquals("zwave"))
                            message = MQTTMessageWrapper.CreateZwaveSetBinaryMsg(DeviceTypeProtocol.ZWAVE, device.getId(), progress);
                        else if (device.type.contains("zigbee"))
                            message = MQTTMessageWrapper.CreateZwaveSetBinaryMsg(DeviceTypeProtocol.ZIGBEE, device.getId(), progress);
                        else if (device.type.contains("upnp"))
                            message = MQTTMessageWrapper.CreateZwaveSetBinaryMsg(DeviceTypeProtocol.UPNP, device.getId(), progress);
        ...
        }if (device instanceof DeviceAEON_LABSHeavyDutySmart)
        {
            ...
            button_humi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        if (device.type.contentEquals("zwave"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.ZWAVE, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_SENSOR_MULTILEVEL, "GET", DeviceAEON_LABSHeavyDutySmart.type_SENSOR_MULTILEVEL_HUMI, "2A", "1/10");
                        else if (device.type.contains("zigbee"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.ZIGBEE, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_SENSOR_MULTILEVEL, "GET", DeviceAEON_LABSHeavyDutySmart.type_SENSOR_MULTILEVEL_HUMI, "2A", "1/10");
                        else if (device.type.contains("upnp"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.UPNP, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_SENSOR_MULTILEVEL, "GET", DeviceAEON_LABSHeavyDutySmart.type_SENSOR_MULTILEVEL_HUMI, "2A", "1/10");
            ...
            button_metter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        if (device.type.contentEquals("zwave"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.ZWAVE, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_METER, "GET", DeviceAEON_LABSHeavyDutySmart.type_METER_POWER, "2A", "1/10");
                        else if (device.type.contains("zigbee"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.ZIGBEE, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_METER, "GET", DeviceAEON_LABSHeavyDutySmart.type_METER_POWER, "2A", "1/10");
                        else if (device.type.contains("upnp"))
                            message = MQTTMessageWrapper.CreateGetSpecificationMsg(DeviceTypeProtocol.UPNP, device.getId(), DeviceAEON_LABSHeavyDutySmart.klass_METER, "GET", DeviceAEON_LABSHeavyDutySmart.type_METER_POWER, "2A", "1/10");
